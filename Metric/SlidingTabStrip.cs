...
namespace Metric
{
    public class SlidingTabStrip : LinearLayout
    {
        ...
        private int[] INDICATOR_COLORS = { 0x000000 };
        ...
        private Paint mBottonBorderPaint;
        ...
        public SlidingTabStrip(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            ...
            mBottonBorderPaint = new Paint();
            mBottonBorderPaint.Color = GetColorFromInteger(0xC5C5C5); //Gray
